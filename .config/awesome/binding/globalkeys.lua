...
function _M.get(_)
  ...
  globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift" }, "y", function()
      awful.spawn.with_shell('maim -s ~/documents/screenshots/$(date +"screenshot-%Y-%m-%d-%H-%M-%S.png")')
    end, { description = "Screenshot to clipboard", group = "Utils" }),
    ...
    awful.key({ modkey }, "u", function()
      awful.spawn("brave --password-store=basic", { tag = awful.screen.focused().selected_tag })
